...
export default function Project({
    ...
    const ImageWithOverlay = ({ src, alt, className, fancyboxSrc, fancyboxCaption }: {
        ...
        >
            ...
            <div className="absolute top-2 right-2 sm:top-4 sm:right-4 bg-white/90 sm:bg-white/80 rounded-full p-1.5 sm:p-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
